...
function seedDB() {
  return {
    users: [
      ...
      { id: "u_est2", name: "Sofía Torres", email: "sofia@brain.edu", pass: "1234", role: "estudiante", color: "#2fae72", grade: "4º A", enrolled: ["c_mat", "c_len", "c_prog", "c_lab", "c_cs", "c_ing", "c_dig", "el_salud", "el_prog", "el_arg"] },
      { id: "u_est3", name: "Bruno Díaz", email: "bruno@brain.edu", pass: "1234", role: "estudiante", color: "#3b82f6", grade: "4º A", enrolled: ["c_mat", "c_len", "c_lab", "c_cs", "c_his", "el_bioeco", "el_hpres"] },
    ],
    courses: [
      ...
      /* ===== Electivos 3° y 4° medio (Formación Diferenciada Humanista-Científica) ===== */
      { id: "el_biocel", name: "Electivo: Biología Celular y Molecular", area: "electivo", teacher: "u_prof2", color: "#2fae72", icon: "🧬", desc: "Biomoléculas, célula, ADN, proteínas, genética y biotecnología." },
      { id: "el_bioeco", name: "Electivo: Biología de los Ecosistemas", area: "electivo", teacher: "u_prof2", color: "#3f9d5a", icon: "🌱", desc: "Origen y evolución de la vida, ecología, biodiversidad y cambio climático en Chile." },
      { id: "el_salud", name: "Electivo: Ciencias de la Salud", area: "electivo", teacher: "u_prof2", color: "#e05260", icon: "🩺", desc: "Salud pública, enfermedades, epidemiología y tecnología en salud." },
      { id: "el_fis", name: "Electivo: Física", area: "electivo", teacher: "u_prof1", color: "#e8a13c", icon: "🔭", desc: "Astronomía, fuerzas centrales, cambio climático y física moderna." },
      { id: "el_qui", name: "Electivo: Química", area: "electivo", teacher: "u_prof1", color: "#14b8a6", icon: "⚗️", desc: "Redox, ácido-base, nanoquímica, termodinámica y sustentabilidad." },
      { id: "el_calc", name: "Electivo: Límites, Derivadas e Integrales", area: "electivo", teacher: "u_prof1", color: "#5b4fc4", icon: "📈", desc: "Introducción al cálculo: funciones, límites, derivadas e integrales." },
      { id: "el_prob", name: "Electivo: Probabilidades y Estadística", area: "electivo", teacher: "u_prof1", color: "#6d5fe0", icon: "🎲", desc: "Estadística descriptiva e inferencial, correlación y modelos de probabilidad." },
      { id: "el_geo3d", name: "Electivo: Geometría 3D", area: "electivo", teacher: "u_prof1", color: "#7c8cf8", icon: "📐", desc: "Geometría analítica en el espacio, vectores y modelado 3D." },
      { id: "el_prog", name: "Electivo: Pensamiento Computacional y Programación", area: "electivo", teacher: "u_prof1", color: "#0ea5a0", icon: "👨‍💻", desc: "Algoritmos, representación de datos y desarrollo de apps." },
      { id: "el_lit", name: "Electivo: Taller de Literatura", area: "electivo", teacher: "u_prof2", color: "#d6455f", icon: "✍️", desc: "Lectura, escritura creativa y creación colaborativa de obras." },
      { id: "el_lee", name: "Electivo: Lectura y Escritura Especializada", area: "electivo", teacher: "u_prof2", color: "#c2456a", icon: "📚", desc: "Comprensión y producción de textos académicos y especializados." },
      { id: "el_arg", name: "Electivo: Participación y Argumentación en Democracia", area: "electivo", teacher: "u_prof2", color: "#b06a3a", icon: "🗣️", desc: "Argumentación, debate y participación crítica en democracia." },
      { id: "el_hpres", name: "Electivo: Comprensión Histórica del Presente", area: "electivo", teacher: "u_prof2", color: "#a15c3a", icon: "🕰️", desc: "Historia reciente, sujetos históricos, memoria y patrimonio." },
      { id: "el_geo", name: "Electivo: Geografía, Territorio y Desafíos Socioambientales", area: "electivo", teacher: "u_prof2", color: "#4d8f6a", icon: "🗺️", desc: "Espacio geográfico, paisaje, planificación territorial y riesgos." },
      { id: "el_global", name: "Electivo: Mundo Global", area: "electivo", teacher: "u_prof2", color: "#3b82f6", icon: "🌍", desc: "Migraciones, conflictos internacionales y cambio climático global." },
    ],
    lessons: [
      ...
      /* ===== ELECTIVOS 3° y 4° medio ===== */
      { id: "e_biocel3", course: "el_biocel", nivel: "3M", title: "Biomoléculas: la base química de la vida", mins: 22, oa: "Electivo · Biología Celular", body: "<p>Las <b>biomoléculas</b> son los compuestos que forman a los seres vivos.</p><ul><li><b>Carbohidratos</b>: energía rápida.</li><li><b>Lípidos</b>: reserva energética y membranas.</li><li><b>Proteínas</b>: estructura y enzimas.</li><li><b>Ácidos nucleicos</b>: ADN y ARN, la información.</li></ul>" },
      { id: "e_biocel4", course: "el_biocel", nivel: "4M", title: "El ADN y el dogma central", mins: 24, oa: "Electivo · Biología Celular", body: "<p>El <b>dogma central</b> describe el flujo de la información genética:</p><p><code>ADN → (transcripción) → ARN → (traducción) → Proteína</code></p><ul><li>La replicación copia el ADN.</li><li>Las proteínas ejecutan las funciones celulares.</li></ul>" },
      { id: "e_bioeco3", course: "el_bioeco", nivel: "3M", title: "Origen de la vida y evolución", mins: 23, oa: "Electivo · Ecosistemas", body: "<p>Distintas <b>teorías científicas</b> explican el origen de la vida (Oparin-Haldane, experimento de Miller y Urey).</p><p>La <b>evolución</b> por selección natural explica la diversidad actual, desde los primeros organismos hasta los homínidos.</p>" },
      { id: "e_bioeco4", course: "el_bioeco", nivel: "4M", title: "Biodiversidad y cambio climático en Chile", mins: 22, oa: "Electivo · Ecosistemas", body: "<p>Chile posee ecosistemas únicos amenazados por el <b>cambio climático</b>.</p><ul><li>Servicios ecosistémicos y su valor.</li><li>Gases de efecto invernadero y zonas de sacrificio.</li><li>Economía circular y ODS como respuestas.</li></ul>" },
      { id: "e_salud3", course: "el_salud", nivel: "3M", title: "Salud pública e indicadores", mins: 21, oa: "Electivo · Cs. de la Salud", body: "<p>La <b>salud pública</b> estudia la salud de las poblaciones.</p><ul><li>Salud es bienestar físico, mental y social.</li><li>Indicadores: esperanza de vida, mortalidad, morbilidad.</li><li>Se relacionan con factores socioeconómicos.</li></ul>" },
      { id: "e_salud4", course: "el_salud", nivel: "4M", title: "Enfermedades y factores de riesgo", mins: 23, oa: "Electivo · Cs. de la Salud", body: "<p>Muchas enfermedades se asocian a <b>factores de riesgo</b> modificables:</p><ul><li>Sedentarismo y malnutrición.</li><li>Consumo de drogas y estrés.</li><li>Prevención: alimentación, actividad física y controles.</li></ul>" },
      { id: "e_fis3", course: "el_fis", nivel: "3M", title: "Astronomía y el cosmos", mins: 24, oa: "Electivo · Física", body: "<p>El <b>universo</b> se originó hace ~13.800 millones de años (Big Bang).</p><ul><li>Estrellas, galaxias y sistemas planetarios.</li><li>Leyes de Kepler del movimiento planetario.</li><li>Chile es una potencia astronómica mundial.</li></ul>" },
      { id: "e_fis4", course: "el_fis", nivel: "4M", title: "Física moderna: relatividad y cuántica", mins: 22, oa: "Electivo · Física", body: "<p>La <b>física moderna</b> revolucionó la comprensión del mundo:</p><ul><li><b>Relatividad</b> (Einstein): espacio y tiempo son relativos.</li><li><b>Mecánica cuántica</b>: el mundo subatómico es probabilístico.</li></ul>" },
      { id: "e_qui3", course: "el_qui", nivel: "3M", title: "Reacciones de óxido-reducción (redox)", mins: 23, oa: "Electivo · Química", body: "<p>En una reacción <b>redox</b> hay transferencia de electrones:</p><ul><li><b>Oxidación</b>: pérdida de electrones.</li><li><b>Reducción</b>: ganancia de electrones.</li><li>Se balancean por el método ión-electrón.</li></ul>" },
      { id: "e_qui4", course: "el_qui", nivel: "4M", title: "Equilibrio químico y sustentabilidad", mins: 22, oa: "Electivo · Química", body: "<p>El <b>equilibrio químico</b> ocurre cuando las reacciones directa e inversa igualan su velocidad.</p><p>El principio de Le Chatelier predice cómo responde ante cambios. Es clave para entender procesos naturales e industriales sustentables.</p>" },
      { id: "e_calc3", course: "el_calc", nivel: "3M", title: "Límites: la idea fundamental del cálculo", mins: 25, oa: "Electivo · Cálculo", body: "<p>El <b>límite</b> describe a qué valor se acerca una función cuando la variable se aproxima a un punto.</p><p>Permite estudiar el comportamiento de funciones incluso donde no están definidas, y es la base de derivadas e integrales.</p>" },
      { id: "e_calc4", course: "el_calc", nivel: "4M", title: "Derivadas e integrales", mins: 26, oa: "Electivo · Cálculo", body: "<p>La <b>derivada</b> mide la razón de cambio (pendiente) de una función.</p><p>La <b>integral</b> es el proceso inverso y calcula el área bajo la curva. Juntas modelan velocidad, crecimiento y acumulación.</p>" },
      { id: "e_prob3", course: "el_prob", nivel: "3M", title: "Estadística descriptiva", mins: 22, oa: "Electivo · Estadística", body: "<p>La <b>estadística descriptiva</b> resume datos:</p><ul><li>Medidas de tendencia central: media, mediana, moda.</li><li>Medidas de dispersión: rango, varianza, desviación estándar.</li><li>La correlación relaciona dos variables.</li></ul>" },
      { id: "e_prob4", course: "el_prob", nivel: "4M", title: "Inferencia estadística", mins: 24, oa: "Electivo · Estadística", body: "<p>La <b>inferencia</b> saca conclusiones sobre una población desde una muestra.</p><ul><li>Modelos normal y binomial.</li><li>Intervalos de confianza.</li><li>Pruebas de hipótesis.</li></ul>" },
      { id: "e_geo3d3", course: "el_geo3d", nivel: "3M", title: "Vectores en el espacio", mins: 21, oa: "Electivo · Geometría 3D", body: "<p>Un <b>vector en el espacio</b> se define por tres componentes (x, y, z).</p><ul><li>Se suman y ponderan componente a componente.</li><li>Se usan para describir rectas y planos en 3D.</li></ul>" },
      { id: "e_geo3d4", course: "el_geo3d", nivel: "4M", title: "Modelado y perspectivas 3D", mins: 20, oa: "Electivo · Geometría 3D", body: "<p>Se pueden generar <b>cuerpos 3D</b> trasladando y rotando figuras 2D.</p><p>En diseño se representan objetos tridimensionales mediante <b>vistas</b> (planta, alzado, perfil) sobre un plano.</p>" },
      { id: "e_prog3", course: "el_prog", nivel: "3M", title: "Algoritmos y representación de datos", mins: 23, oa: "Electivo · Programación", body: "<p>Un <b>algoritmo</b> es una secuencia de pasos para resolver un problema.</p><p>El computador representa todo dato (texto, imagen, sonido) en <b>código binario</b> (0 y 1).</p>" },
      { id: "e_prog4", course: "el_prog", nivel: "4M", title: "Desarrollo de aplicaciones", mins: 22, oa: "Electivo · Programación", body: "<p>Con herramientas visuales (como App Inventor) se crean <b>apps móviles</b>:</p><ul><li>Interfaz de usuario y componentes.</li><li>Bloques de lógica y eventos.</li><li>Uso de sensores del dispositivo.</li></ul>" },
      { id: "e_lit3", course: "el_lit", nivel: "3M", title: "Del romanticismo a las vanguardias", mins: 24, oa: "Electivo · Taller de Literatura", body: "<p>Una <b>trayectoria de lectura</b> recorre la poesía desde el <b>Romanticismo</b> (emoción y libertad) hasta las <b>Vanguardias</b> (ruptura y experimentación), pasando por el Modernismo y la Generación del 27.</p>" },
      { id: "e_lit4", course: "el_lit", nivel: "4M", title: "Crear una narración", mins: 22, oa: "Electivo · Taller de Literatura", body: "<p>Para <b>crear una historia</b>:</p><ul><li>Elegí un conflicto que la estructure.</li><li>Construí personajes con motivaciones.</li><li>Ordená el tiempo y el espacio narrativo.</li></ul>" },
      { id: "e_lee3", course: "el_lee", nivel: "3M", title: "La competencia lectora", mins: 21, oa: "Electivo · Lectura Especializada", body: "<p>Leer comprensivamente activa <b>habilidades cognitivas</b>:</p><ul><li>Reconocer la estructura del texto.</li><li>Sintetizar con macrorreglas.</li><li>Inferir e interpretar.</li></ul>" },
      { id: "e_lee4", course: "el_lee", nivel: "4M", title: "El texto académico y la investigación", mins: 23, oa: "Electivo · Lectura Especializada", body: "<p>Un <b>trabajo de investigación</b> se organiza en fases:</p><ol><li>Elegir tema y tipo de investigación.</li><li>Buscar y organizar fuentes confiables.</li><li>Redactar introducción, cuerpo y conclusión.</li></ol>" },
      { id: "e_arg3", course: "el_arg", nivel: "3M", title: "La argumentación y sus tipos", mins: 22, oa: "Electivo · Argumentación", body: "<p><b>Argumentar</b> es sostener una postura con razones.</p><ul><li>Tipos de argumentos: de autoridad, causa, ejemplo, analogía.</li><li>Modelo de Toulmin: tesis, garantía y respaldo.</li></ul>" },
      { id: "e_arg4", course: "el_arg", nivel: "4M", title: "El debate y las falacias", mins: 23, oa: "Electivo · Argumentación", body: "<p>El <b>debate</b> es una discusión formal y reglada.</p><ul><li>Escuchar y refutar con respeto.</li><li>Detectar <b>falacias</b> (argumentos que parecen válidos pero no lo son).</li><li>Buscar acuerdos mediante la negociación.</li></ul>" },
      { id: "e_hpres3", course: "el_hpres", nivel: "3M", title: "La historia reciente", mins: 20, oa: "Electivo · Historia del Presente", body: "<p>La <b>historia reciente</b> estudia el pasado cercano que aún incide en el presente.</p><ul><li>Periodización: cambios y continuidades.</li><li>Fuentes: orales, visuales y documentales.</li></ul>" },
      { id: "e_hpres4", course: "el_hpres", nivel: "4M", title: "Memoria, patrimonio e historia oral", mins: 21, oa: "Electivo · Historia del Presente", body: "<p>La <b>memoria</b> y el <b>patrimonio</b> conectan a la comunidad con su pasado.</p><p>La <b>historia oral</b> recupera testimonios de personas para reconstruir la historia local y cotidiana.</p>" },
      { id: "e_geo3", course: "el_geo", nivel: "3M", title: "El espacio geográfico y el paisaje", mins: 21, oa: "Electivo · Geografía", body: "<p>El <b>espacio geográfico</b> es construido por la sociedad a lo largo del tiempo.</p><ul><li>El <b>paisaje</b> cambia por causas naturales y humanas.</li><li>Relación ser humano-entorno: determinismo y posibilismo.</li></ul>" },
      { id: "e_geo4", course: "el_geo", nivel: "4M", title: "Planificación territorial y riesgos", mins: 20, oa: "Electivo · Geografía", body: "<p>La <b>planificación territorial</b> ordena el uso del espacio buscando el desarrollo sustentable.</p><p>En Chile es clave la gestión de <b>riesgos socionaturales</b> (sismos, aluviones, incendios) y la participación ciudadana.</p>" },
      { id: "e_global3", course: "el_global", nivel: "3M", title: "Migraciones en un mundo global", mins: 22, oa: "Electivo · Mundo Global", body: "<p>Las <b>migraciones</b> son un fenómeno central del mundo globalizado.</p><ul><li>Causas económicas, políticas y ambientales.</li><li>Aportes al mercado laboral y remesas.</li><li>Los derechos humanos de las personas migrantes.</li></ul>" },
      { id: "e_global4", course: "el_global", nivel: "4M", title: "Conflictos internacionales y cambio climático", mins: 21, oa: "Electivo · Mundo Global", body: "<p>Los <b>conflictos internacionales</b> tienen dimensiones económicas y afectan a múltiples escalas.</p><p>El <b>cambio climático</b> es un desafío global que requiere acuerdos entre los Estados y acción local.</p>" },
    ],
    quizzes: [
